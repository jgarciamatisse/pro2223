...
import _03ejerciciosInterfacesYGenericidad._03publicaciones.Libro;
import _03ejerciciosInterfacesYGenericidad._03publicaciones.Publicacion;
import _03ejerciciosInterfacesYGenericidad._03publicaciones.Revista;
...
public class Ordenacion {
	...
	private static void mostrarPorAnyoDecreciente(ArrayList<Publicacion> l) {
		...
		//o bien ...
		Collections.sort(l, (p1,p2)-> {return p2.getAnyo() - p1.getAnyo();});
		for (Publicacion p : l) {
			System.out.println(p);
		}
	}
